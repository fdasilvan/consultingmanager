...
namespace ConsultingManager.Domain
{
    public class InfraToDto : Profile
    {
        public InfraToDto()
        {
            ...
            CreateMap<CommentDto, CommentPoco>().ForAllOtherMembers(opts => opts.MapAtRuntime());
            ...
            CreateMap<UserCustomerCategoryPoco, UserCustomerCategoryDto>().ForAllOtherMembers(opts => opts.MapAtRuntime());
