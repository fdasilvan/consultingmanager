...
namespace ConsultingManager.Domain.Repository
{
    public interface ITaskRepository
    {
        ...
        Task<List<CustomerStepDto>> RescheduleStep(Guid customerStepId, int businessDaysToAdd);
        Task<CustomerProcessDto> RescheduleProcess(Guid customerProcessId, int businessDaysToAdd);
