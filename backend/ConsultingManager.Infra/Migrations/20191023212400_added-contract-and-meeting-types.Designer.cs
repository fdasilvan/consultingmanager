...
namespace ConsultingManager.Infra.Migrations
{
    ...
    [Migration("20191023212400_added-contract-and-meeting-types")]
    partial class addedcontractandmeetingtypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.CancellationReasonPoco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.ContractPoco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<Guid?>("ContractSituationId");
                    ...
                    b.HasIndex("ContractSituationId");

                    b.HasIndex("CustomerId");

                    b.HasIndex("PlanId");

                    b.ToTable("ContractPoco");
                });

            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.ContractSituationPoco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.CustomerCancellationPoco", b =>
                {
                    ...
                    b.ToTable("CustomerCancellations");
                });
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.CustomerContactPoco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.CustomerSituationPoco", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("241b42ea-05c7-4e7f-81b0-758a688e1a56"),
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.MeetingTypePoco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0a5d9561-6518-47a5-89f3-034f4d0256cd"),
                            Description = "Implantação"
                        },
                        new
                        {
                            Id = new Guid("38cbb2dd-e1a9-4535-a00a-dcd81cf4fd82"),
                            Description = "Consultoria"
                        },
                        new
                        {
                            Id = new Guid("c203d729-d70a-4bb8-853a-879ef62dabe1"),
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.PlanPoco", b =>
                {
                    ...
                    b.Property<bool>("AllowGroupMeeting");

                    b.Property<int>("ConsultingFrequency");

                    b.Property<int>("ConsultingQuantity");

                    b.Property<string>("Description");

                    b.Property<int>("Duration");

                    b.Property<int>("ImplantationFrequency");

                    b.Property<int>("ImplantationQuantity");
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.TeamPoco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f186fca-eeb3-48d8-a0f0-7387545eb60d"),
                            Description = "Implantação"
                        },
                        new
                        {
                            Id = new Guid("eedcaac4-6db4-4bb1-b102-5493d0116183"),
                            Description = "Consultoria"
                        });
                });
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.UserCustomerCategoryPoco", b =>
                {
                    ...
                    b.HasKey("UserId", "CustomerCategoryId");
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.UserCustomerLevelPoco", b =>
                {
                    ...
                    b.HasKey("UserId", "CustomerLevelId");
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.UserPoco", b =>
                {
                    ...
                    b.Property<int?>("AvailableHoursMonth");
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.UserTypePoco", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("bb159acc-cb7d-476d-9c45-1a75dafed934"),
                            Description = "Implantador"
                        });
                });
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.ContractPoco", b =>
                {
                    b.HasOne("ConsultingManager.Infra.Database.Models.ContractSituationPoco", "ContractSituation")
                        .WithMany()
                        .HasForeignKey("ContractSituationId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.CustomerCancellationPoco", b =>
                {
                    b.HasOne("ConsultingManager.Infra.Database.Models.CancellationReasonPoco", "CancellationReason")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsultingManager.Infra.Database.Models.CustomerMeetingPoco", b =>
                {
                    b.HasOne("ConsultingManager.Infra.Database.Models.ContractPoco", "Contract")
                        .WithMany()
                    ...
                    b.HasOne("ConsultingManager.Infra.Database.Models.ContractPoco", "MeetingType")
                        .WithMany()
