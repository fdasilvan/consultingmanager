...
export class TimelineService {
    ...
    public async getAll(): Promise<Process[]> {
        ...
        task5.startDate = new Date(2019, 3, 30);
        task5.endDate = new Date(2019, 3, 30);
        ...
        task6.startDate = new Date(2019, 4, 1);
        task6.endDate = new Date(2019, 4, 1);
        ...
        task7.startDate = new Date(2019, 4, 1);
        task7.endDate = new Date(2019, 4, 2);
        ...
        task8.duration = 30;
        task8.creationDate = new Date(2019, 3, 24);
        task8.startDate = new Date(2019, 4, 2);
        task8.endDate = new Date(2019, 4, 2);
        ...
        task9.startDate = new Date(2019, 4, 2);
        task9.endDate = new Date(2019, 4, 3);
